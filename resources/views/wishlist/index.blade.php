    ...
    <div class="container mb-4">
        <div class="row">
            @if(count($items))
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{route('wishlist.cart',['id'=>$item->id])}}">Add to cart</a>

                                        {!! Form::open(['route'=>['wishlist.destroy',$item->associatedModel->id],'method'=>'DELETE']) !!}
                ...
                <div class="col-md-4 mt-4">
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-block btn-danger" href="{{route('wishlist.clear')}}">Clear Wish list</a>
                        </div>
        ...
        @else
            <div class="row w-100 align-items-center justify-content-center" style="min-height: 60vh">
                <div class="col-md-8">
                    <h4 class="text-center">Your wishlist is currently empty</h4>
                </div>
            </div>
